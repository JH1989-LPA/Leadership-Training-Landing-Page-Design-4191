...
const BusinessCase=({onOpenModal})=> {
  const benefits=[ 
    {icon: FiTrendingUp,benefit: "Höhere Führungsqualität",value: "Entlastung der Linie,bessere Entscheidungen"},
    {icon: FiHeart,benefit: "Höhere Mitarbeiterbindung",value: "durch souveräne Führung & Anerkennung"},
    {icon: FiClock,benefit: "Klar kalkulierbarer Aufwand",value: "feste Struktur,planbare Zeiten"},
    {icon: FiTarget,benefit: "Entwicklung statt Zufall",value: "keine Einzelfalllösungen mehr"},
    {icon: FiAward,benefit: "Signal nach innen",value: "Wir investieren in unsere Leute"} 
  ];
